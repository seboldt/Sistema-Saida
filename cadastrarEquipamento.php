        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">                        
                            <form action="function/cadastrarEquipamento.php" method="POST">
                                <label>Nome Equipamento: </label>
                                <input class="form-control" type="text" name="equipamento" required /><br />
                                <label>Marca Equipamento: </label>
                ...
                <div class="row">
                    <div class="col-md-6">
                    <?php
                        $queryTecnico = "SELECT * FROM equipamento ORDER BY ds_equipamento;";
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while ($rowTecnico = mysqli_fetch_array($resultado)) {
                                        echo "<tr>";
                                            echo "<td>".$rowTecnico['ds_equipamento']."</td>";                           
                                            echo "<td>".$rowTecnico['ds_marca']."</td>";
                                            echo "<td>".$rowTecnico['ds_modelo']."</td>";
                                            echo "<td><a href='excluirTecnico.php?".$rowTecnico['id_tecnico']."'><i class='glyphicon glyphicon-trash'></i></a></td>";
                                        echo "</tr>";
                                    }
