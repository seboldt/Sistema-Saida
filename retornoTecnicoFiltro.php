        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <form action="retornoTecnicoFiltro.php" method="POST">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name='filtroTecnico' required>
                                        ...
                                        <?php
                                            $queryTeste = "SELECT * FROM tecnico ORDER BY ds_nome";
               ...
               <div class="row">
                    <div class="col-md-6">
                        <?php
                            $queryTecnico = "SELECT * FROM registro_saida INNER JOIN tecnico ON registro_saida.id_tecnico = tecnico.id_tecnico WHERE registro_saida.id_tecnico=$tec AND registro_saida.codigo is NULL ORDER BY data DESC;";
                            ...
                            <tbody>
                                <?php
                                    while ($row = mysqli_fetch_array($resultado)) {        
                                        ...
                                        if($row['codigo'] == NULL){
                                            ?>
                                                <form action="function/confirmacao.php" method="POST">
                                                    <td><input type="text" name="codigo" required /></td>
                                                    <?php echo "<input type='hidden' name='id' value='".$row['id_saida'].";' />"; ?> 
                                                    <td><input class="btn btn-primary" type="submit" value="Baixa" /></td>
                                                </form>
                                            <?php
                                        }else{
