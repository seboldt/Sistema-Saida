        ...
        <div id="page-wrapper">
            <div id="page-inner">
               ...
               <div class="row">
                    <div class="col-md-6">
                        <?php
                            $queryTecnico = "SELECT * FROM registro_saida INNER JOIN tecnico ON registro_saida.id_tecnico = tecnico.id_tecnico WHERE registro_saida.codigo is NOT NULL ORDER BY data DESC;";
